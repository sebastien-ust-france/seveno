...
export function CandidatePrivacyNotice({
  ...
  return (
    <SevenoPanel tone="blue" className="p-4 sm:p-5">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-cyan-300/20 bg-[linear-gradient(135deg,rgba(34,211,238,0.14),rgb(var(--seveno-brand-blue)/0.10),rgba(249,115,22,0.08))] text-cyan-100 shadow-[0_0_0_1px_rgba(34,211,238,0.08),0_0_24px_rgba(34,211,238,0.10)]">
