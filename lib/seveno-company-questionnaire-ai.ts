...
export function buildCompanyQuestionnaireAiPrompt(
  ...
  return [
    ...
    '- Pour multiple_choice, indique clairement dans la question que plusieurs réponses sont attendues et conserve des options lisibles dans la limite de 15 secondes.',
    ...
    '- Chaque question doit être lisible et répondable en 15 secondes.',
